...
GVAR(digPFH) = [{
    (_this select 0) params ["_unit", "_trench", "_path"];
	...
	_surface = surfaceType _basePos;
	if (_surface != GVAR(trenchSurface)) then {
...
}, 0, [_unit, _trench, _path]] call CBA_fnc_addPerFrameHandler;
