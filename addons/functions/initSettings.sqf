...
[QGVAR(shortEnvelopeRemovalTime), "SLIDER", localize LSTRING(ShortEnvelopeRemovalTime), [localize LSTRING(settingCategory), localize LSTRING(trenchSubCategory)], [5, 300, 15, 0], true] call CBA_fnc_addSetting;
...
[QGVAR(smallEnvelopeRemovalTime), "SLIDER", localize LSTRING(SmallEnvelopeRemovalTime), [localize LSTRING(settingCategory), localize LSTRING(trenchSubCategory)], [5, 450, 30, 0], true] call CBA_fnc_addSetting;
...
[QGVAR(bigEnvelopeRemovalTime), "SLIDER", localize LSTRING(BigEnvelopeRemovalTime), [localize LSTRING(settingCategory), localize LSTRING(trenchSubCategory)], [5, 600, 40, 0], true] call CBA_fnc_addSetting;
...
[QGVAR(giantEnvelopeRemovalTime), "SLIDER", localize LSTRING(GiantEnvelopeRemovalTime), [localize LSTRING(settingCategory), localize LSTRING(trenchSubCategory)], [5, 900, 90, 0], true] call CBA_fnc_addSetting;
...
[QGVAR(vehicleEnvelopeRemovalTime), "SLIDER", localize LSTRING(VehicleEnvelopeRemovalTime), [localize LSTRING(settingCategory), localize LSTRING(trenchSubCategory)], [5, 1200, 120, 0], true] call CBA_fnc_addSetting;
...
[QGVAR(LongEnvelopeRemovalTime), "SLIDER", localize LSTRING(LongEnvelopeRemovalTime), [localize LSTRING(settingCategory), localize LSTRING(trenchSubCategory)], [5, 1200, 100, 0], true] call CBA_fnc_addSetting;
